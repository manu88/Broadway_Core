...
/*
 ...
 ----------------+-----------+--------------+--------------+--------------+-------------+----------------+
 Library/ dep    | EGL       | Open GL ES 2 |   Open VG    | Open MAX     |   FFMPEG    |  linux-can     |
 ----------------+-----------+--------------+--------------+--------------+-------------+----------------+
 Macro           | HAVE_EGL  |  HAVE_GLES2  | HAVE_OPENVG  | HAVE_OPENMAX | HAVE_FFMPEG | HAVE_LINUX_CAN |
 ================o===========o==============o==============o==============o=============o================o
 BeagleBoneBlack |   YES     |   YES        |     ?        |    ?         |       ?     |    YES         |
 ----------------+-----------+--------------+--------------+--------------+-------------+----------------+
 RaspberryPI     |   YES     |   YES        |     YES      |    YES       |     YES     |    YES?        |
 ----------------+-----------+--------------+--------------+--------------+-------------+----------------+
 Cubieboard2     |   YES     |   YES        |      NO      |    NO?       |       ?     |    YES?        |
 ----------------+-----------+--------------+--------------+--------------+-------------+----------------+
 Macos           |           |              |              |              |     YES     |    YES?        |
 ----------------+-----------+--------------+--------------+--------------+-------------+----------------+
